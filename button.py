...
all = [ # noqa
    [types.KeyboardButton(text="✈️Foydalanuvchilarga malumot yuborish"), types.KeyboardButton(text="❎Bant qilingan joylarni korish")], # noqa
    [types.KeyboardButton(text="🆕Menuga taom qoshish"), types.KeyboardButton(text="✂️Xonani o'chirish:")] # noqa
]
